...
output "compliance_status" {
  ...
  value = {
    "CC7.1" = {
      ...
      status      = "COMPLIANT"
      resource_id = var.enable_activity_log_alerts ? azurerm_monitor_activity_log_alert.role_change[0].id : "alerts-disabled"
    ...
    "CC7.2" = {
      ...
      status      = "COMPLIANT"
      resource_id = var.enable_activity_log_alerts && var.key_vault_id != null ? azurerm_monitor_activity_log_alert.kv_access[0].id : "alerts-disabled"
    ...
    "CC8.1" = {
      ...
      status      = "COMPLIANT"
      resource_id = var.enable_activity_log_alerts ? azurerm_monitor_activity_log_alert.policy_change[0].id : "alerts-disabled"
